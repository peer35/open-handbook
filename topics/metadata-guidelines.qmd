...
The VU data management policy requires published datasets to be registered in the research information system [Pure](/tools/pure/index.qmd) and rhe minimal metadata specification includes the necessary properties that allows for dataset registration in Pure. 
