...
The VU data management policy requires published datasets to be registered in the research information system [Pure](/tools/pure/index.qmd) and the minimal metadata specification includes the necessary properties that allows for dataset registration in Pure. 
...
For example, consider metadata describing this page (the dataset), we could say:
...
The following lists the common *properties* of descriptive metadata. Always make sure at least the mandatory properties are present.
