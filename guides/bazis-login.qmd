...
You will receive a temporary password by email once your account is created, which you can use to connect to the cluster using ssh. If you do not have an account yet, you can request one [via this form](https://services.vu.nl/esc?id=sc_cat_item&sys_id=83139c79473e8150bfa46d72e36d432e).  
...
9. Done! You are now connected to the BAZIS cluster and visually acces your selected folder. 
